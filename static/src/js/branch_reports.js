odoo.define('account_analytic_report.branch_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
            ...
            if (!this.M2MFilters) {
                ...
                if (this.report_options.analytic_tags) {
                    fields['analytic_tags'] = {
                        label: _t('Branch Tags'),
                        modelName: 'branch.analytic.tag',
    ...
    add_edit_footnote: function(e) {
        ...
        var $content = $(QWeb.render('account_analytic_report.footnote_dialog', {text: text, line: line_id}));
        var save = function() {
...
core.action_registry.add('branch_report', accountReportsWidget);
